...
//		login_music = 'sound/ambience/clown.ogg'
	...
	do
		...
		world << "<B><FONT color='blue'>Добро пожаловать, заблудшаЯ душа!</FONT></B>"
		world << "Настройте своего и персонажа и готовьтесь к игре. Игра начнетсЯ через [pregame_timeleft] секунд"
...
/datum/controller/gameticker/proc/setup()
	...
	spawn(0)//Forking here so we dont have to wait for this to finish
		...
		for(var/obj/effect/landmark/start/S in landmarks_list)
			...
			if (S.name != "AI")
				qdel(S)
		world << "<FONT color='blue'><B>При&#255;тного раунда!</B></FONT>"
