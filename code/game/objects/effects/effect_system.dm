...
/obj/effect/effect/fuelwater/process()
	...
	for(var/direction in cardinal)
		...
		var/obj/effect/effect/fuelwater/F = locate() in T
		if(F)
			continue
...
/obj/effect/effect/radwater/two/two


/obj/effect/effect/radwater/two/two/New(loc, var/ismetal=0)
	..(loc)
	spawn(3)
		process()
	spawn(120)
...
/obj/effect/effect/radwater/two/two/process()
	...
	for(var/direction in cardinal)
		...
		var/obj/effect/effect/radwater/two/two/F = locate() in T
		if(F)
			continue
...
/obj/effect/effect/capsaicinwater/process()
	...
	for(var/direction in cardinal)
		...
		var/obj/effect/effect/capsaicinwater/F = locate() in T
		if(F)
			continue
...
/obj/effect/effect/tripwater/process()
	...
	for(var/direction in cardinal)
		...
		var/obj/effect/effect/tripwater/F = locate() in T
		if(F)
			continue

		F = new(T)

/obj/effect/effect/radwater/two/two/Crossed(mob/living/carbon/human/M as mob )
	..()
	reagents.reaction(M)

/obj/effect/effect/capsaicinwater/Crossed(mob/living/carbon/human/M as mob )
	..()
	reagents.reaction(M)

/obj/effect/effect/tripwater/Crossed(mob/living/carbon/human/M as mob )
	..()
	reagents.reaction(M)


/obj/effect/effect/fuelwater/Crossed(mob/living/carbon/human/M as mob )
	..()
	reagents.reaction(M)
