...
proc/make_mining_asteroid_secret()
	...
	switch(pick(possiblethemes))//what kind of room is this gonna be?
		...
		if("cavein")
			...
			floortypes = list(/turf/simulated/floor/plating/asteroid/airless)
		...
		if("speakeasy")
			...
			treasureitems = list(/obj/item/weapon/melee/energy/sword/pirate=1,/obj/item/weapon/gun/projectile/revolver/doublebarrel=1, /obj/machinery/reagentgrinder=2,
			 /obj/effect/effect/beerkeg=5, /obj/machinery/computer/security/wooden_tv=4, /obj/machinery/vending/coffee=3)
			fluffitems = list(/obj/structure/table/woodentable=2,/obj/effect/effect/beerkeg=1,/obj/item/weapon/spacecash/c500=4,
